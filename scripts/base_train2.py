...
parser.add_argument("--lr-cycle-amplitude", type=float, default=0.00, help="relative amplitude of cyclic LR modulation (0.10 = +/-10%%)")
parser.add_argument("--lr-cycle-period", type=int, default=100, help="period of cyclic LR modulation in optimizer steps")
...
def get_lr_multiplier(it):
    ...
    # Add a high-frequency sinusoidal component around the original schedule.
    cycle_multiplier = 1.0 + args.lr_cycle_amplitude * math.sin(
        2.0 * math.pi * it / args.lr_cycle_period
    )
